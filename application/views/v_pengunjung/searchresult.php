        ...
        <div class="container">
            ...
            <div class="col-lg-7" style="margin-top: 80px;">
                <div class="section-title mb-4">
                    <h5 class="position-relative d-inline-block text-primary text-uppercase">Berikut hasil pencarian yang Anda isikan</h5>
                </div>
    ...
    <?php
            if (empty($data_cari)) {
                echo "<h6><center><i class='far fa-frown'> Yah, Destinasi tujuan yang kaka cari tidak ada dalam paket yang tersedia </i></center></h6>";
            }
            ?>
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row g-0" style="justify-content: center; margin-top: -60px;">
                <?php foreach ($data_cari as $dc) : ?>
                    <div class="col-lg-2 mx-4 my-4 box2">
                        <a href="<?= base_url('c_pengunjung/paketpilihan/'); ?><?= $dc['id_paket_wisata']; ?>">
                            <img src="<?php echo base_url(); ?>assets/img/paket_wisata/<?= $dc['foto_paket_wisata']; ?>" class="card-img-top sampul" alt="">
                            <div class="card-body">
                                <?php $pembulatan_rating = round($dc['rating_paket_wisata'], 2); ?>
                                ...
                                <h6 class="card-text text-secondary"><?= "Rp." . number_format($dc['harga_paket_wisata'], 2, ',', '.'); ?></h6>
                                <center>
                                    <h6 class="text-secondary option"><?= $dc['nama_paket_wisata'] ?></h6>
                                    <h6 class="text-secondary option"><?= $dc['ndt'] ?></h6>
                                <center>
                            </div>
                        </a>
                    </div>
