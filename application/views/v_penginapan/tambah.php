        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php base_url('c_penginapan/tambah_data/'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="nama_penginapan">Nama Penginapan</label>
                            <input type="text" class="form-control" id="nama_penginapan" name="nama_penginapan"  placeholder="Contoh : Hotel Setia Abadi">
                            <?= form_error('nama_penginapan', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="alamat_penginapan">Alamat Penginapan</label>
                            <input type="text" class="form-control" id="alamat_penginapan" name="alamat_penginapan"  placeholder="Contoh : Jalan Mangga No.2, Madiun, Jawa Timur">
                            <?= form_error('alamat_penginapan', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="jumlah_orang">Jumlah Orang</label>
                            <input type="text" class="form-control" id="jumlah_orang" name="jumlah_orang"  placeholder="Contoh : 2">
                            <?= form_error('jumlah_orang', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="fasilitas_penginapan">Fasilitas</label>
                            <input type="text" class="form-control" id="fasilitas_penginapan" name="fasilitas_penginapan"  placeholder="Contoh : Kolam renang, play ground, bath tube">
