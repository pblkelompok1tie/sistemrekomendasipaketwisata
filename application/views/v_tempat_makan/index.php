                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php foreach ($tempat_makan as $a) : ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= $a['nama_tempat_makan']; ?></td>
                                        <td><?= $a['alamat_tempat_makan']; ?></td>
                                        <td><?= $a['menu_favorite']; ?></td>
                                        <td>
                                            <img src="<?php echo base_url(); ?>assets/img/tempat_makan/<?= $a['foto_tempat_makan']; ?>" width="100" height="100">
                                        </td>
                                        <td>
                                            <a href="<?= base_url('c_tempat_makan/edit_data/'); ?><?= $a['id_tempat_makan']; ?>" class="badge badge-success">
                                                <i class="fas fa-edit"></i>
                                                edit</a>
                                            <a onclick="deleteConfirm('<?= base_url('c_tempat_makan/hapus_data/' . $a['id_tempat_makan']) ?>')" href="#!" class="badge badge-danger"><i class="far fa-trash-alt"></i> Delete</a>
                                        </td>
